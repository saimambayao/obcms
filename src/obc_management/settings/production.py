...
# Temporarily allow insecure cookies for debugging (Sevalla proxy issues)
# Set REQUIRE_SECURE_COOKIES=true in environment to enforce
REQUIRE_SECURE_COOKIES = env.bool("REQUIRE_SECURE_COOKIES", default=False)

SESSION_COOKIE_SECURE = REQUIRE_SECURE_COOKIES
CSRF_COOKIE_SECURE = REQUIRE_SECURE_COOKIES
SESSION_COOKIE_HTTPONLY = True
CSRF_COOKIE_HTTPONLY = True
SESSION_COOKIE_SAMESITE = "Lax" if not REQUIRE_SECURE_COOKIES else "Strict"
CSRF_COOKIE_SAMESITE = "Lax" if not REQUIRE_SECURE_COOKIES else "Strict"
