    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_document', models.ForeignKey(blank=True, help_text='Parent document if this is a version', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='versions', to='documents.document')),
                ...
                ('category', models.ForeignKey(blank=True, help_text='Category this document belongs to', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='documents', to='documents.documentcategory')),
            ],
            options={
